...
/// \brief Definition of the MagFieldParam: container for ALICE mag. field
/// parameters \author ruben.shahoyan@cern.ch
...
public:
  ...
  MagFieldParam(const char *name = "", const char *title = "",
                const char *context = "");
